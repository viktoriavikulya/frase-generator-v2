const RETRO_PALETTES = [
  ...
  { id: "retroLime",     bg: "#76c442", frontColor: "#1a2e00", midColor: "#1a2e00", shadowColor: "#0cbbc4", patternColor: "#1a2e00",      patternAlpha: 0.22, inCycle: true },
  { id: "retroSkyDeep",  bg: "#1565c0", frontColor: "#e3f2fd", midColor: "#e3f2fd", shadowColor: "#ff6d00", patternColor: "#e3f2fd",      patternAlpha: 0.16, inCycle: true },
];

const BG_SEQUENCE = RETRO_PALETTES
  .filter(p => p.inCycle)
  .map(p => p.bg);

module.exports = { RETRO_PALETTES, BG_SEQUENCE };